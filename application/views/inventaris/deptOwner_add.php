        ...
        <div class="card-body justify-content-center">
            <form method="post" action="">
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="kode_deptOwner" name="kode_deptOwner" readonly value="<?= sprintf("%03s", $kode) ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="nama_deptOwner" name="nama_deptOwner" value="<?= set_value('nama_deptOwner') ?>">
