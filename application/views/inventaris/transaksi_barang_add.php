    ...
    <div class="card-body justify-content-center">
      <form method="post" action="">
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" id="kode_transaksibarang" name="kode_transaksibarang" value="<?= set_value('kode_transaksibarang') ?>">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" id="masa_garansi" name="masa_garansi" value="<?= set_value('masa_garansi') ?>">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" id="path_foto" name="path_foto" value="<?= set_value('path_foto') ?>">
